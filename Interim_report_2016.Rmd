...
colnames(df) <- c('Site', 'X','mono', "Month of Highest Correlation", "Higest Correlation", "Correlation Coefficient", "Shift", "Species")
kable(df[c("Site", "Month of Highest Correlation", "Higest Correlation", "Correlation Coefficient", "Species")], format = "markdown")
```
