...
ghcn.clean <- full.ghcn[!is.na(full.ghcn$RWI_1),]
# split training and testing datasets:
library(caTools)
msk <- sample.split( ghcn.clean, SplitRatio = 3/4, group = NULL )
...
# add struct.cohort and struct.cohort.code (if it doesnt alread exist)
...
#need to define site level structures, if we havent already:
