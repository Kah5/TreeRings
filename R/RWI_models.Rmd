...
# project into the future (assuming 35% further change in drought senseiivty & temperature):
  for(i in 1:nfut){
   Yfut.35.35[i]  ~ dnorm(mufut35[i],inv.var)
    mufut35[i] <- beta1[site.fut[i]] + (beta2[struct.cohort.fut[i]]*0.65)*DI.scaled.fut[i] + beta3[struct.cohort.fut[i]]*DBH.scaled.fut[i] +beta4[struct.cohort.fut[i]]*log_RWI_1.fut[i] +beta5[struct.cohort.fut[i]]*log_RWI_2.fut[i] + (beta6[struct.cohort.fut[i]]*0.65)*Temp.scaled.fut[i]
  }
...
# project into the future (assuming 50% further change in drought senseiivty):
  for(i in 1:nfut){
   Yfut.50.50[i]  ~ dnorm(mufut50[i],inv.var)
    mufut50[i] <- beta1[site.fut[i]] + (beta2[struct.cohort.fut[i]]*0.50)*DI.scaled.fut[i] + beta3[struct.cohort.fut[i]]*DBH.scaled.fut[i] +beta4[struct.cohort.fut[i]]*log_RWI_1.fut[i] +beta5[struct.cohort.fut[i]]*log_RWI_2.fut[i] + (beta6[struct.cohort.fut[i]]*0.50)*Temp.scaled.fut[i]
  }
