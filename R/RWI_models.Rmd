...
test.dry <- readRDS("outputs//growth_model/lag2_reg_struct_x_cohort_re_t_pr_dry_yrs/test.dry.rds")
train.dry <- readRDS("outputs//growth_model/lag2_reg_struct_x_cohort_re_t_pr_dry_yrs/train.dry.rds")
...
# plot marginal distributions of cohort + structure specific parameters:
a <- data.frame(alpha.samps)
colnames(a) <- c(paste0("alpha-",c(unique(train.dry$struct.cohort))))
a$num <- rownames(a)
a.m <- melt(a, id.vars=c("num"))
alpha.mplots <- ggplot(a.m, aes(value, fill = variable))+geom_density(alpha = 0.5)+theme_bw()+xlab("Random intercepts")
...
b3 <- data.frame(beta3.samps)
colnames(b3) <- c(paste0(c(unique(train.dry$struct.cohort))))
b3$num <- rownames(b3)
b3.m <- melt(b3, id.vars=c("num"))
b3.mplots <- ggplot(b3.m, aes(value, fill = variable))+geom_density(alpha = 0.5)+theme_bw()+xlab("DBH Index slope")
...
b4 <- data.frame(beta4.samps)
colnames(b4) <- c(paste0(c(unique(train.dry$struct.cohort))))
b4$num <- rownames(b4)
b4.m <- melt(b4, id.vars=c("num"))
b4.mplots <- ggplot(b4.m, aes(value, fill = variable))+geom_density(alpha = 0.5)+theme_bw()+xlab("Log_RWI-1 Index slope")

b5 <- data.frame(beta5.samps)
colnames(b5) <- c(paste0(c(unique(train.dry$struct.cohort))))
b5$num <- rownames(b5)
b5.m <- melt(b5, id.vars=c("num"))
b5.mplots <- ggplot(b5.m, aes(value, fill = variable))+geom_density(alpha = 0.5)+theme_bw()+xlab("Log_RWI-2 Index slope")

b6 <- data.frame(beta6.samps)
colnames(b6) <- c(paste0(c(unique(train.dry$struct.cohort))))
b6$num <- rownames(b6)
b6.m <- melt(b6, id.vars=c("num"))
b6.mplots <- ggplot(b6.m, aes(value, fill = variable))+geom_density(alpha = 0.5)+theme_bw()+xlab("Summer Temperature slope")
...
b3 <- data.frame(beta3.samps)
colnames(b3) <- c(paste0("beta3-",c(unique(train.dry$struct.cohort))))
b3$num <- rownames(b3)
b3.m <- melt(b3, id.vars=c("num"))
b3.mplots <- ggplot(b3.m, aes(value, fill = variable))+geom_density(alpha = 0.5)+theme_bw()+xlab("DBH slope")

b4 <- data.frame(beta4.samps)
colnames(b4) <- c(paste0("beta4-",c(unique(train.dry$struct.cohort))))
b4$num <- rownames(b4)
b4.m <- melt(b4, id.vars=c("num"))
b4.mplots <- ggplot(b4.m, aes(value, fill = variable))+geom_density(alpha = 0.5)+theme_bw()+xlab("lag - 1 effect")

b5 <- data.frame(beta5.samps)
colnames(b5) <- c(paste0("beta5-",c(unique(train.dry$struct.cohort))))
b5$num <- rownames(b5)
b5.m <- melt(b5, id.vars=c("num"))
b5.mplots <- ggplot(b5.m, aes(value, fill = variable))+geom_density(alpha = 0.5)+theme_bw()+xlab("lag - 1 effect")
...
prob_10_60cm_avg <- prob %>% dplyr::filter(DBH == 3 | DBH == 27 | DBH == 63 , Tmax == 71 | Tmax == 88, RWI_1 == 0.285, RWI_2 == 0.103 ) 
...
prob_10_60cm_low <- prob %>% dplyr::filter(DBH == 3 | DBH == 27 | DBH == 63 , Tmax == 71 | Tmax == 88, RWI_1 == -1.215, RWI_2 == -1.397  ) 
...
png(height = 10, width = 8, units = "in", res = 300, "outputs/growth_model/lag2_reg_struct_x_cohort_re_t_pr_dry_yrs/MAP_response_low_high_temp_low_high_DBH.png")
...
"Modern-Savanna"='#dfc27d',
"Modern-Forest"='#c7eae5',
"Past-Forest"='#018571'))+facet_grid(vars(DBH), vars(Tmax))+xlab("MAP index")
dev.off()
...
prob_lowMAP <- prob %>% dplyr::filter(MAP == 225 , Tmax == 71 | Tmax == 88 , RWI_1 == -1.215 | RWI_1 == 0.285 | RWI_1 == 1.785 , RWI_2 == -1.397 | RWI_2 == 0.103 | RWI_2 == 1.603 ) 
...
ggplot(prob_lowMAP_ci[prob_lowMAP_ci$Tmax == 71,], aes(DBH, meanY, color = cohort))+geom_point()+facet_grid(vars(RWI_1), vars(RWI_2)) + ylim(0,6)
