...
colnames(Yfut.samps) <- paste0(fut$site, "_",fut$year, "_", fut$DBH.scaled, "_", fut$RWI_1, "_", fut$RWI_2)
Yfut.samps$num <- 1:length(Yfut.samps[,2])
fut.m <- melt(Yfut.samps)
fut.m$RWI <- exp(fut.m$value)
colnames(fut.m) <- c("site_year", "Ypred", "RWI")

fut$site_year <- paste0(fut$site, "_",fut$year, "_", fut$DBH.scaled, "_", fut$RWI_1, "_", fut$RWI_2)
...
colnames(Yfut.35.samps) <-  paste0(fut$site, "_",fut$year, "_", fut$DBH.scaled, fut$RWI_1, "_", fut$RWI_2)
...
fut$site_year <-  paste0(fut$site, "_",fut$year, "_", fut$DBH.scaled, fut$RWI_1, "_", fut$RWI_2)
...
colnames(Yfut.50.samps) <-  paste0(fut$site, "_",fut$year, "_", fut$DBH.scaled, fut$RWI_1, "_", fut$RWI_2)
...
colnames(Yfut.35.35.samps) <-  paste0(fut$site, "_",fut$year, "_", fut$DBH.scaled, fut$RWI_1, "_", fut$RWI_2)
...
colnames(Yfut.50.50.samps) <-  paste0(fut$site, "_",fut$year, "_", fut$DBH.scaled, fut$RWI_1, "_", fut$RWI_2)
