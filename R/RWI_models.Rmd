...
# plot marginal distributions of cohort + structure specific parameters:
a <- data.frame(alpha.samps)
colnames(a) <- c(paste0("alpha-",c(as.character(unique(full.ghcn$structure)))))
a$num <- rownames(a)
a.m <- melt(a, id.vars=c("num"))
...
b2 <- data.frame(beta2.samps)
colnames(b2) <- c(paste0("beta2-",c(as.character(unique(full.ghcn$structure)))))
b2$num <- rownames(b2)
b2.m <- melt(b2, id.vars=c("num"))
...
b3 <- data.frame(beta3.samps)
colnames(b3) <- c(paste0("beta3-",c(as.character(unique(full.ghcn$structure)))))
b3$num <- rownames(b3)
b3.m <- melt(b3, id.vars=c("num"))
