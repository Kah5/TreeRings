...
cohort_struct_scaled <- full.ghcn %>% group_by(ageclass, site) %>%
...
write.csv(full.ghcn, "outputs/full.ghcn.sites.struct.before.splitting_cohort.site.scaled.csv", row.names = FALSE)
...
saveRDS(ghcn.clean, "outputs/growth_model/ghcn.clean.full.data_site_cohort_scaled_v3.rds")
...
saveRDS(sub.ghcn, 'data/full_dataset_site_cohort_scaled_v4.rds')
saveRDS(train, 'data/train_dataset_site_cohort_scaled_v4.rds')
saveRDS(test, 'data/test_dataset_site_cohort_scaled_v4.rds')
...
# save the split testing and training data for use later on:
saveRDS(dry.yrs.paired, 'data/full_dry_paired_site_cohort_scaled_dataset_v5.rds')
saveRDS(train.dry.pair, 'data/train_dry_paired_site_cohort_scaled_dataset_v5.rds')
saveRDS(test.dry.pair, 'data/test_dry_paired_site_cohort_scaled_dataset_v5.rds')
...
saveRDS(full.iso, 'data/full_WUE_site_cohort_scaled_dataset_v4.rds')
saveRDS(train.iso, 'data/train_WUE_site_cohort_scaled_dataset_v4.rds')
saveRDS(test.iso, 'data/test_WUE_site_cohort_scaled_dataset_v4.rds')
