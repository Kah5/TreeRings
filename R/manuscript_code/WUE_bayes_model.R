...
params <- samps[,1:16]
saveRDS(params, "outputs/growth_model/iWUE_MAP_TMAX_dbh_cohort/params.iWUE_struct.cohort_v3.rds")
...
saveRDS(iWUE_map_tmax.re, "outputs/growth_model/iWUE_MAP_TMAX_dbh_cohort/samps.iWUE_age.cohort.re_v3.rds")
...
params <- samps[,1:8]
saveRDS(params, "outputs/growth_model/iWUE_MAP_TMAX_dbh_cohort/params.iWUE_ageclass_v3.rds")
...
# note fairly poor model fit
png(width = 6, height = 5, units = "in", res = 300, "outputs/growth_model/iWUE_MAP_TMAX_dbh/pred_vs_obs_ageclass_WUE_v3.png")
p.o.plot
dev.off()
...
# function g()
iWUEfunc[i] <- beta1[struct.cohort[i]] + beta2[struct.cohort[i]]*MAP_scaled[i] + beta3[struct.cohort[i]]*TMAX_scaled[i] + beta4[struct.cohort[i]]*DBH_scaled[i]#+beta5[structure[i]]
...
saveRDS(d13C_map_tmax.re, "outputs/growth_model/iWUE_MAP_TMAX_dbh_cohort/samps.d13_struct.cohort_v3.rds")
#Yp.samps <- samps[,1:660] # one alpha for each of 16 sites
#iWUEpred <- samps
...
# note fairly poor model fit
png(width = 6, height = 5, units = "in", res = 300, "outputs/growth_model/iWUE_MAP_TMAX_dbh/pred_vs_obs_d13C_v3.png")
p.o.plot
dev.off()
...
d13samps       <- d13C_map_tmax.re [[1]]
saveRDS(d13samps, "outputs/growth_model/iWUE_MAP_TMAX_dbh_cohort/samps.d13_ageclass_v3.rds")
#Yp.samps <- samps[,1:660] # one alpha for each of 16 sites
#iWUEpred <- samps
...
# note fairly poor model fit
png(width = 6, height = 5, units = "in", res = 300, "outputs/growth_model/iWUE_MAP_TMAX_dbh/pred_vs_obs_d13C_ageclass_v3.png")
p.o.plot
dev.off()
