...
sites.modeled$Structure <- c("Forest", "Savanna", "Forest", "Savanna", "Forest", "Savanna", "Savanna", "Forest", "Savanna")
...
mod1 <- read.csv("/Users/kah/Documents/TreeRings2/outputs/growth_model/model_summary/lag2_reg_cohort_only_re_t_pr_dry_yrs_site_rs_inter_summary_v3.csv")
...
mod1.dev <- readRDS("/Users/kah/Documents/TreeRings2/outputs/growth_model/model_summary/lag2_reg_cohort_only_re_t_pr_dry_yrs_site_rs_inter_DIC_v3.rds")
mod2.dev <- readRDS("/Users/kah/Documents/TreeRings2/outputs/growth_model/model_summary/lag2_reg_struct_x_cohort_re_t_pr_dry_yrs_site_rs_inter_DIC_v3.rds")
...
samps <- readRDS("/Users/kah/Documents/TreeRings2/outputs/growth_model/lag2_reg_struct_x_cohort_re_t_pr_dry_yrs_site_rs_inter/samps_v3.rds")
test.dry <- readRDS("/Users/kah/Documents/TreeRings2/data/test_dry_paired_dataset_v3.rds")
train.dry <- readRDS("/Users/kah/Documents/TreeRings2/data/train_dry_paired_dataset_v3.rds")
...
# # --------read in estimates  + 95% CI for Mod:
 samps.mod2 <- readRDS("/Users/kah/Documents/TreeRings2/outputs/growth_model/lag2_reg_struct_x_cohort_re_t_pr_dry_yrs_site_rs_inter/samps_v3.rds")
