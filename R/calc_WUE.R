...
d13.growth[d13.growth$site %in% "BON" & d13.growth$year %in% old.yrs.bon ,]$class <- "Past"
d13.growth[d13.growth$site %in% "BON" & d13.growth$year %in% young.yrs.bon ,]$class <-  "Modern"
