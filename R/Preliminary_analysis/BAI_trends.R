...
Hickory.bai <- read_detrend_year(filename = "cleanrwl/HICww.rwl", method = "none", rwiorbai = "bai", site = "HIC")
...
Coral.bai <- read_detrend_year(filename = "cleanrwl/CORww.rwl", method = "Spline", rwiorbai = "bai", site = "COR")
Uncas.bai <- read_detrend_year(filename = "cleanrwl/UNCww.rwl", method = "Spline", rwiorbai = "bai", site = "UNC")
Glacial.bai <- read_detrend_year(filename = "cleanrwl/GLAww.rwl", method = "Spline", rwiorbai = "bai", site = "GLA")
...
GLL1.bai <- read_detrend_year(filename = "cleanrwl/GLL1ww.rwl", method = "Spline", rwiorbai = "bai", site = "GLL1")
GLL2.bai <- read_detrend_year("cleanrwl/GLL2ww.rwl", method = "Spline", rwiorbai = "bai", site = "GLL2")
GLL3.bai <- read_detrend_year("cleanrwl/GLL3ww.rwl", method = "Spline", rwiorbai = "bai", site = "GLL3")
GLL4.bai <- read_detrend_year("cleanrwl/GLL4ww.rwl", method = "Spline", rwiorbai = "bai", site = "GLL4")
PVC.bai <- read_detrend_year("cleanrwl/PVCww.rwl", method = "Spline", rwiorbai = "bai", site = "PVC")
AVO.bai <- read_detrend_year(filename = "cleanrwl/AVOww.rwl", method = "Spline", rwiorbai = "bai", site = "AVO")
UNI.bai <- read_detrend_year("cleanrwl/UNIww.rwl", method = "Spline", rwiorbai = "bai", site = "UNI")
...
ggplot(det.age.clim.ghcn.df, aes(x = Jul.pdsi, y = RWI*0.01, color = ageclass))+geom_point()+stat_smooth(method = 'lm')+facet_wrap(~site, ncol = 5)
...
write.csv(det.age.clim.prism.df.locs, "outputs/data/BAI_age_prism.df")
write.csv(det.age.clim.ghcn.df.locs, "outputs/data/BAI_age_ghcn.df")
...
write.csv(det.age.clim.class.ghcn.dbh.df, "outputs/data/bai_age_dbh_ghcn.df")
write.csv(det.age.clim.class.prism.dbh.df, "outputs/data/bai_age_dbh_prism.df")
