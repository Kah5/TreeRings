...
int.dot.age <- ggplot(data.frame(a1.sum), aes(x = mean.val, y = site.num, color = structure, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+
  geom_point(alpha = 0.5)+scale_color_manual(values = c("Savanna"='sienna4', 'Forest' = "forestgreen"))+theme_bw(base_size = 14)+theme(legend.position = "none", axis.title.y = element_blank(), panel.grid = element_blank())+xlab(expression(paste("Estimated Intercept (", alpha[s], ")")))+xlim(-0.3, 0.8) + geom_vline(xintercept = 0, linetype = "dashed")
...
b2.dot.age <- ggplot(data.frame(b2.sum), aes(x = mean.val, y = cohort, color = cohort, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+
  geom_point(alpha = 0.5)+xlim(-0.1, 0.25)+scale_color_manual(values = c("Past"='#2166ac', 'Modern' = "#b2182b"))+theme_bw(base_size = 14)+theme(legend.position = "none", axis.title.y = element_blank(), panel.grid = element_blank())+xlab(expression(paste("Estimated Precip. Sensitivity (", beta[1], ")")))+xlim(-0.3, 0.8)+ geom_vline(xintercept = 0, linetype = "dashed")
...
b3.dot.age <- ggplot(data.frame(b3.sum), aes(x = mean.val, y = cohort, color = cohort, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+
  geom_point(alpha = 0.5)+xlim(-0.1, 0.25)+scale_color_manual(values = c("Past"='#2166ac', 'Modern' = "#b2182b"))+theme_bw(base_size = 14)+theme(legend.position = "none", axis.title.y = element_blank(), panel.grid = element_blank())+xlab(expression(paste("Estimated DBH Sensitivity (", beta[6], ")")))+xlim(-0.3, 0.8)+ geom_vline(xintercept = 0, linetype = "dashed")
...
b4.dot.age <- ggplot(data.frame(b4.sum), aes(x = mean.val, y = cohort, color = cohort, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+
  geom_point(alpha = 0.5)+scale_color_manual(values = c("Past"='#2166ac', 'Modern' = "#b2182b"))+theme_bw(base_size = 14)+theme(legend.position = "none", axis.title.y = element_blank(), panel.grid = element_blank())+xlab(expression(paste("Estimated lag-1 growth coef. (", beta[5], ")")))+xlim(-0.3, 0.8)+ geom_vline(xintercept = 0, linetype = "dashed")
...
b5.dot.age <- ggplot(data.frame(b5.sum), aes(x = mean.val, y = cohort, color = cohort, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+
  geom_point(alpha = 0.5)+scale_color_manual(values = c("Past"='#2166ac', 'Modern' = "#b2182b"))+theme_bw(base_size = 14)+theme(legend.position = "none", axis.title.y= element_blank(), panel.grid = element_blank())+xlab(expression(paste("Estimated lag-2 growth coef. (", beta[6], ")")))+xlim(-0.3, 0.8)+ geom_vline(xintercept = 0, linetype = "dashed")
...
b6.dot.age <- ggplot(data.frame(b6.sum), aes(x = mean.val, y = cohort, color = cohort, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+
  geom_point(alpha = 0.5)+scale_color_manual(values = c("Past"='#2166ac', 'Modern' = "#b2182b"))+theme_bw(base_size = 14)+theme(legend.position = "none", axis.title.y = element_blank(), panel.grid = element_blank())+xlab(expression(paste("Estimated Max. Temp. sensitivity (", beta[2], ")")))+xlim(-0.3, 0.8)+ geom_vline(xintercept = 0, linetype = "dashed")
...
b7.dot.age <- ggplot(data.frame(b7.sum), aes(x = mean.val, y = cohort, color = cohort, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+
  geom_point(alpha = 0.5)+scale_color_manual(values = c("Past"='#2166ac', 'Modern' = "#b2182b"))+theme_bw(base_size = 14)+theme(legend.position = "none", axis.title.y = element_blank(), panel.grid = element_blank())+xlab(expression(paste("Estimated Temp*Precip sensitivity (", beta[3], ")")))+xlim(-0.3, 0.8)+ geom_vline(xintercept = 0, linetype = "dashed")
...
b2.dot <- ggplot(data.frame(b2.sum), aes(x = mean.val, y = variable, color = variable, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+geom_point(alpha = 0.5)+xlim(-0.15, 0.8)+scale_color_manual(values = c("Past-Savanna"='#a6611a',
...
b3.dot <- ggplot(data.frame(b3.sum), aes(x = mean.val, y = variable, color = variable, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+geom_point(alpha = 0.5)+xlim(-0.19, 0.71)+scale_color_manual(values = c("Past-Savanna"='#a6611a',
                                                                                                                                                                                                                                        "Modern-Savanna"='#dfc27d',
                                                                                                                                                                                                                                        "Modern-Forest"='#80cdc1',
...
b4.dot <- ggplot(data.frame(b4.sum), aes(x = mean.val, y = variable, color = variable, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+geom_point(alpha = 0.5)+scale_color_manual(values = c("Past-Savanna"='#a6611a',
                                                                                                                                                                                                                      "Modern-Savanna"='#dfc27d',
                                                                                                                                                                                                                      "Modern-Forest"='#80cdc1',
...
b5.dot <- ggplot(data.frame(b5.sum), aes(x = mean.val, y = variable, color = variable, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+geom_point(alpha = 0.5)+scale_color_manual(values = c("Past-Savanna"='#a6611a',
                                                                                                                                                                                                                      "Modern-Savanna"='#dfc27d',
                                                                                                                                                                                                                      "Modern-Forest"='#80cdc1',
...
b6.dot <- ggplot(data.frame(b6.sum), aes(x = mean.val, y = variable, color = variable, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+geom_point(alpha = 0.5)+scale_color_manual(values = c("Past-Savanna"='#a6611a',
                                                                                                                                                                                                                      "Modern-Savanna"='#dfc27d',
                                                                                                                                                                                                                      "Modern-Forest"='#80cdc1',
...
b7.dot <- ggplot(data.frame(b7.sum), aes(x = mean.val, y = variable, color = variable, size = 2))+geom_errorbarh( aes(xmin = Ci.low, xmax = Ci.high, size = 1,height = 0))+geom_point(alpha = 0.5)+scale_color_manual(values = c("Past-Savanna"='#a6611a',
                                                                                                                                                                                                                      "Modern-Savanna"='#dfc27d',
                                                                                                                                                                                                                      "Modern-Forest"='#80cdc1',
