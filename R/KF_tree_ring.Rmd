...
# moving corrlations between climate and tree growth:

a<- dcc(Hickory, IL.clim[1:1452,c("Year", "Month", "TMAX")], dynamic = 'moving')
a
...
#these funcitons print out plots in correlations
