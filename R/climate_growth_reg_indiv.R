...
#detrend 
Hickory <- detrend(rwl = Hickory, method = "ModNegExp")
...
#detrend
Bonanza <- detrend(rwl = Bonanza, method = "ModNegExp")
...
#detrend
Pleasant <- detrend(rwl = Pleasant, method = "ModNegExp")
...
#detrend
Townsend <- detrend(rwl = Townsend, method = "ModNegExp")
...
annuals.HIC <- merge(annuals, Hickory, by = "Year")
...
#merge annuals with hickory
annuals.BON <- merge(annuals, Bonanza, by = 'Year')
...
annuals <- data.frame(Year = annual.p$Year, 
                      ...
                      PDSI = annual.pdsi$PDSI)
#merge annuals with hickory
annuals.PLE <- merge(annuals, Pleasant, by = 'Year')
...
#merge annuals with hickory
annuals.TOW <- merge(annuals, Townsend, by = 'Year')
