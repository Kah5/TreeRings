...
kable(beta.full, "latex", align = "c", booktabs = T, caption = "Parameter Estimates and Model Fit") %>%
  add_header_above(c(" " = 2, "Model 1" = 2, "Model 2" = 2)) %>%
kable_styling() %>% collapse_rows(1, latex_hline = "major") %>% group_rows("Model Fit", 34, 38) %>% row_spec(33, hline_after = TRUE)
```
