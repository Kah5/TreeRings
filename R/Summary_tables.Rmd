...
sites.modeled <- sites.modeled[,c("Site #", "Site", "Mean Age", "Time span", "Intercorrelation", "AR", "EPS", "Rbar")]
...
```{r, results="asis", echo = FALSE}
full.ghcn <- read.csv("/Users/kah/Documents/TreeRings/outputs/data/rwi_age_dbh_ghcn.csv")
...
for(i in 1:length(site.list)){
  ...
  write.csv(df.corrs, paste0("/Users/kah/Documents/TreeRings/outputs/site_summary/", site.list[i], "_int_ar1.csv"), row.names = FALSE)
}
...
for(i in 1:length(site.list)){
  ...
  write.csv(df.corrs, paste0("/Users/kah/Documents/TreeRings/outputs/site_summary/", site.list[i], "_int_ar1_byageclass.csv"), row.names = FALSE)
}
...
# directory that all the csv files are in
data.dir <- "/Users/kah/Documents/TreeRings/outputs/site_summary/"
...
kable(age.summary, "latex", align=c("l", "l", "l","c","c", "c", "c", "c", "c"), booktabs = T, caption = "Site Summaries and Age Cohort Summaries", digits = 2) %>% column_spec(4:9, width = "2cm")%>%
kable_styling() %>% collapse_rows(1, latex_hline = "major")
